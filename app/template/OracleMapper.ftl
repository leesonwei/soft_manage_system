...
<mapper namespace="${content.dao.classPackage}.${content.dao.className}">
	...
	<#--<!-- ${content.mapper.item.assist.value}是查询辅助工具类, ${r'${req.require}'}表示列名,${r'#{req.value}'}表示值它是防SQL注入的 &ndash;&gt;-->
	...
	<#--<!-- ${content.mapper.item.updateAssist.value}用于更新数据查询辅助工具类,作用${content.mapper.item.assist.value}与一致 &ndash;&gt;-->
	...
	<#--</select>-->
	<#---->
	<#--<!-- 获得类名为:${content.entity.className}对应数据库中表的数据集合 &ndash;&gt;-->
	...
	<#--<!-- 通过${content.entity.className}的id获得对应数据库中表的数据对象 &ndash;&gt;-->
	...
	<#--</#if>-->
	<#---->
	<#--<!-- 获得一个${content.entity.className}对象,以参数${content.entity.className}对象中不为空的属性作为条件进行查询 &ndash;&gt;-->
	...
	<#--</select>-->
	<#---->
	<#--<!-- 获得${content.entity.className}对象,以参数${content.entity.className}对象中不为空的属性作为条件进行查询 &ndash;&gt;-->
	...
	<#--<!-- 将${content.entity.className}插入到对应数据库的表中,包括属性值为null的数据 &ndash;&gt;-->
	...
	<#--<!-- 将${content.entity.className}中属性值不为null的数据,插入到对应数据库的表中 &ndash;&gt;-->
	...
	<#--<!-- 将${content.entity.className}批量插入到对应数据库的表中 &ndash;&gt;-->
	...
	<#---->
	<#--<#if content.entity.primaryKeyAttr??>-->
	<#--<!-- 通过${content.entity.className}的id将数据库表中对应的数据删除 &ndash;&gt;-->
	...
	<#--<!-- 通过辅助工具Assist中的条件将${content.entity.className}对应的数据库表的数据删除 &ndash;&gt;-->
	...
	<#---->
	<#--<#if content.entity.primaryKeyAttr??>-->
	<#--<!-- 通过${content.entity.className}的id将${content.entity.className}的数据更新到数据库中对应的表,包括值null的数据 &ndash;&gt;-->
	...
	<#---->
	<#--<#if content.entity.primaryKeyAttr??>-->
	<#--<!-- 通过${content.entity.className}的id将${content.entity.className}中属性值不为null的数据更新到数据库对应的表中 &ndash;&gt;-->
	...
	<#--</#if>-->
	<#---->
	<#--<!-- 通过辅助工具Assist中的条件将${content.entity.className}中的数据更新到数据库对应的表中,包括值为null的数据 &ndash;&gt;-->
	...
	<#--<!-- 通过辅助工具Assist中的条件将${content.entity.className}中属性值不为null的数据更新到数据库对应的表中 &ndash;&gt;-->
